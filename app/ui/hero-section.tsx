...
export default function HeroSection() {
  return (
    <div
      ...
      className="relative inset-0 h-screen w-screen overflow-hidden bg-[url('/hero-section.png')] bg-cover bg-center"
    >
...
function CharacterShowCase() {
  return (
    <div
      data-testid="character-showcase"
      className="absolute bottom-0 left-0 h-[60vh] md:h-[30vh]"
    >
